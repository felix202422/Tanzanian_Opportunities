...
import tdop.rbac.PermissionEvaluatorImpl;
...
public class SecurityConfig {
    ...
    @Bean
    public MethodSecurityExpressionHandler methodSecurityExpressionHandler(PermissionEvaluatorImpl permissionEvaluator) {
