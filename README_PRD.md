...
It should NOT automatically accuse a person or organization without evidence.
...
The product should not look like a generic copied Western SaaS dashboard.
...
REFERENCE:
README_PRD.md → Developer 01 sections
...
PRIMARY AREA:
Organization / Admin / Trust / Platform Operations

REFERENCE:
README_PRD.md → Developer 02 sections
