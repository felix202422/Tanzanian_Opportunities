...
<div>
<h1 className="text-3xl font-bold text-tdop-navy">Moderation Queue</h1>
<p className="text-gray-500 mt-1">Review and moderate opportunities</p>
</div>
...
<div>
<p className="text-2xl font-bold text-tdop-navy">{items.length}</p>
...
<h2 className="text-lg font-semibold text-tdop-navy">Pending Opportunities</h2>
</div>
