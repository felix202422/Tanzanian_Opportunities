...
<div>
<h1 className="text-3xl font-bold text-tdop-navy">Verification Officer Dashboard</h1>
<p className="text-gray-500 mt-1">Review and process organization verification requests</p>
</div>
...
<div>
<p className="text-2xl font-bold text-tdop-navy">{stats.pending}</p>
...
<h2 className="text-lg font-semibold text-tdop-navy">Pending Verification Requests</h2>
</div>
...
<h3 className="font-medium text-tdop-navy">{req.organization?.orgName}</h3>
