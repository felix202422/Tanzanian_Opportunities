...
const OpportunityModerationPage: React.FC = () => {
 ...
 <p className="text-center text-gray-500 py-8">{t('admin.noPendingOpportunities')}</p>
 ) : (
 pendingOpps.slice(0, 10).map(opp => (
 <div key={opp.id} className="flex items-center justify-between p-4 hover:bg-gray-50">
 <div>
 ...
 <p className="text-center text-gray-500 py-8">{t('admin.noRejectedOpportunities')}</p>
 ) : (
