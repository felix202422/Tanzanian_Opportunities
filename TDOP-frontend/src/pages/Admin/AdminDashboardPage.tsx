...
const AdminDashboardPage: React.FC = () => {
 ...
 const adminStats = [
 { label: t('admin.totalUsers'), value: stats.totalUsers, icon: Users, color: 'bg-blue-100 text-blue-600' },
 { label: t('admin.activeUsers'), value: stats.activeUsers, icon: Activity, color: 'bg-green-100 text-green-600' },
 { label: t('admin.totalOpportunities'), value: stats.totalOpportunities, icon: Briefcase, color: 'bg-purple-100 text-purple-600' },
 { label: t('admin.verifiedOpportunities'), value: stats.verifiedOpportunities, icon: Shield, color: 'bg-yellow-100 text-yellow-600' },
 { label: t('admin.pendingVerification'), value: stats.pendingVerification, icon: Calendar, color: 'bg-orange-100 text-orange-600' },
 { label: t('admin.totalApplications'), value: stats.totalApplications, icon: FileText, color: 'bg-indigo-100 text-indigo-600' },
 { label: t('admin.totalReports'), value: stats.totalReports, icon: FileText, color: 'bg-red-100 text-red-600' },
 { label: t('admin.pendingReports'), value: stats.pendingReports, icon: AlertCircle, color: 'bg-red-100 text-red-600' },
 ];
