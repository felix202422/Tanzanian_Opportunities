...
const VerificationPage: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-slide-up">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t('organization.verification')}</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1">{t('organization.submitVerification')}</p>
      </div>
      ...
      <Card>
        <div className="space-y-6">
          <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">{t('profile.verificationStatus')}</h3>
          ...
          <div>
            <h3 className="font-medium text-gray-900 dark:text-white mb-2">{t('organization.uploadVerificationDoc')}</h3>
