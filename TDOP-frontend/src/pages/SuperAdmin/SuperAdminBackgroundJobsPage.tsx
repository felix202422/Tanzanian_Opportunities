  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Scheduled tasks and background job monitoring</p>
      </div>
      ...
      <Card className="overflow-hidden">
        <div className="px-5 py-3 border-b bg-gray-50">
          <h3 className="text-sm font-semibold text-tdop-navy">Scheduled Jobs</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b">
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Job Name</th>
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Schedule</th>
            ...
            <tbody className="divide-y">
              ...
              {jobs.length === 0 && (
                <tr><td colSpan={4} className="px-4 py-8 text-center text-gray-500 text-sm">No background jobs found.</td></tr>
              )}
            </tbody>
          </table>
        </div>
