...
import { Bell, CheckCheck, Info, CheckCircle2, AlertTriangle, XCircle, Clock, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-3">
          {notifications.map((notif: any) => {
            ...
            return (
              <Card
                key={notif.id}
                className={`transition-all ${!notif.read ? 'ring-1 ring-tdop-primary/20 bg-tdop-primary/[0.02]' : ''}`}
                padding={false}
              >
