...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, icon, suffix, as = 'input', rows, options, className = '', id, ...props }, ref) => {
    const commonInputClasses = 'block w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-tdop-navy placeholder-gray-400 focus:ring-2 focus:ring-tdop-primary/20 focus:border-tdop-primary outline-none transition-all duration-200';
